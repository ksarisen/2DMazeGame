...
public class CharactersTest {
    ...
    void playerMoveUp_withoutBlocked() {
        Player player = new Player(0,"null",1,1,new Point(16,3),new GamePanel(frame),new Image("Car-East.png"));
        player.moveUp();
    ...
    void enemyMoveUp_withBlocked_ByHelicopter() {
        Enemy enemy = new Enemy(8,1,1,new Image("Car-East.png"),new Point(21,2),new GamePanel(frame));
    ...
    void playerMoveDown_withBlocked_ByGrass() {
        Player player = new Player(0,"null",1,1,new Point(3,2),new GamePanel(frame),new Image("Car-East.png"));
        assertFalse(player.moveDown(), "Wrong movement when there is grass blocked down the player");
    }
    @Test
    void enemyMoveDown_withoutBlocked() {
        Enemy enemy = new Enemy(8,1,1,new Image("Car-East.png"),new Point(8,2),new GamePanel(frame));
        enemy.moveDown();
    ...
    void playerMoveLeft_withoutBlocked() {
        Player player = new Player(0,"null",1,1,new Point(7,8),new GamePanel(frame),new Image("Car-East.png"));
        player.moveLeft();
    ...
    void enemyMoveLeft_withBlocked_ByGrass() {
        Enemy enemy = new Enemy(8,1,1,new Image("Car-East.png"),new Point(16,9),new GamePanel(frame));
    ...
    void playerMoveRight_withBlocked_ByGrass() {
        Player player = new Player(0,"null",1,1,new Point(16,9),new GamePanel(frame),new Image("Car-East.png"));
    ...
    void enemyMoveRight_withoutBlocked() {
        Enemy enemy = new Enemy(8,1,1,new Image("Car-East.png"),new Point(18,11),new GamePanel(frame));
        enemy.moveRight();
